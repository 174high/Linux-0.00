...
! 加电或者复位之后，基地址是0，长度值被设置为0XFFF，在保护模式初始化过程中
!，必须给GDTR加载一个新值
! absolute address 0x00000, in 32-bit protected mode.
	mov	ax,#0x0001	! protected mode (PE) bit 进入保护模式
	lmsw	ax		! This is it!
	jmpi	0,8		! jmp offset 0 of segment 8 (cs)  1000 段选择符，
				! 选择第二个，作为全局描述符			
				! 述符，所以从线性基地址8 偏移0开始运行程序

gdt:	.word	0,0,0,0		! dummy
	!空选择符，处理器不使用DGT表的第一个，这个就是第一个
	.word	0x07FF		! 8Mb - limit=2047 (2048*4096=8Mb)
	.word	0x0000		! base address=0x00000  基地址
